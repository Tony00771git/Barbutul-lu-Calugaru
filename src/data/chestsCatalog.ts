...
export const ALL_CHEST_COSMETICS: CosmeticItem[] = [
  ...
  {
    id: 'cosmetic_cardback_parchment',
    type: 'cardBack',
    rarity: 'milspec',
    name: 'Spate Cărți: Pergament Vechi',
    nameEn: 'Card Back: Ancient Parchment',
    descRo: 'Pergament medieval din piele tăbăcită și sigilat cu ceară.',
    descEn: 'Aged parchment sealed with monastic wax stamp.',
    icon: '📜',
    exclusiveToChest: true,
    cardBackKey: 'cardback_rustic_wood',
  ...
  },
  {
    ...
    type: 'theme',
    rarity: 'restricted',
    name: 'Tema: Pădurea Vrăjită',
    nameEn: 'Theme: Enchanted Forest',
    descRo: 'Pădure de smarald cu monoliti runici și licurici magici.',
    descEn: 'Emerald forest canopy with runic monoliths and fireflies.',
    icon: '🌲',
    exclusiveToChest: true,
  ...
  },
  {
    ...
    type: 'avatar',
    rarity: 'restricted',
    name: 'Avatar: Alchimistul Ciumei',
  ...
  {
    id: 'cosmetic_special_royal_treasury',
    type: 'theme',
    rarity: 'rareSpecial',
